...
| `slow_movement_acc_degs_per_sec2` | float | No | Max joint acceleration (degrees/sec²) for the slow tier. Gentle acceleration matters more than top speed for both precision and sloshing. Default `0` leaves the arm's own acceleration in place; lower it to ease into and out of contact and carries. |
