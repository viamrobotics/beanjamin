...
Orchestrates a full coffee brew cycle using a `filter-poses-switch` component. Supports preparing espresso and lungo orders, executing individual actions, and cancellation.
