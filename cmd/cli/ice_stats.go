...
// Least-squares and summary statistics shared by the ice commands.
//
// These were written for the depth calibration (ice-fit), which is gone: depth
// does not work at the dispense pose. ice-level still fits measured height
// against poured level the same way, so the math outlived the command.
