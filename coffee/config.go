...
type Config struct {
	...
	// remote, e.g. "delivery-bot:delivery-handler") that this service can send
	// one-way messages to with the send_delivery_message DoCommand. The peer
	// receives each message as a receive_message DoCommand. Unset disables
	// outbound messaging.
